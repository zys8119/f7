...
<html>
  <head>
    ...
    <link rel="stylesheet" href="http://192.168.0.110:81/public/css/ios/framework7.ios.css">
    <link rel="stylesheet" href="http://192.168.0.110:81/public/css/ios/framework7.ios.colors.css">
  ...
  <body>
    ...
    <div class="panel panel-left panel-cover layout-dark">
      <div class="content-block-title">左侧面板 left
        <div class="content-block"><a href="#" class="close-panel">关闭我</a><br><a href="#" data-panel="right" class="open-panel col-100">右侧面板</a></div>
        <div class="content-block-title">功能表</div>
        <div class="list-block">
          <ul>
            ...
            <li><a href="media-lists.html" class=" close-panel   item-link">
                <div class="item-content">
                  <div class="item-media"><i class="icon icon-f7"></i></div>
                  <div class="item-inner">
            ...
            <li><a href="swiper.html" class=" close-panel   item-link">
                <div class="item-content">
                  <div class="item-media"><i class="icon icon-f7"></i></div>
                  <div class="item-inner">
      ...
      <div class="view view-right">
        <div class="navbar">
          <div class="navbar-inner">
            <div class="center sliding">右侧面板</div>
          </div>
        </div>
        <div class="pages navbar-through">
          <div data-page="panel-right1" class="page">
            <div class="page-content">
              <div class="content-block"><a href="#" class="close-panel">关闭我</a></div>
              <div class="list-block">
                <ul>
                  <li><a href="panel-right2.html" class="  item-link">
                      <div class="item-content">
                        <div class="item-media"><i class="icon icon-f7"></i></div>
                        <div class="item-inner">
                          <div class="item-title">右面板页面2</div>
                        </div>
                      </div></a></li>
                  <li><a href="panel-right3.html" class="  item-link">
                      <div class="item-content">
                        <div class="item-media"><i class="icon icon-f7"></i></div>
                        <div class="item-inner">
                          <div class="item-title">右面板页面3</div>
                        </div>
                      </div></a></li>
                </ul>
              </div>
      ...
      <div class="view view-main">
        <div class="navbar">
          <div class="navbar-inner">
            ...
            <div class="center sliding">Framework7 iOS</div>
        ...
        <div class="pages navbar-through toolbar-through">
          <div data-page="index" class="page">
            <div class="page-content">
              <div class="content-block-title">欢迎来到FRAMEWORK7</div>
              <div class="content-block"><a href="about.html" class="button">关于FRAMEWORK7</a></div>
                ...
                <ul>
                  ...
                  <li><a href="autocomplete.html" class="  item-link">
                      <div class="item-content">
                        <div class="item-media"><i class="icon icon-f7"></i></div>
                        <div class="item-inner">
                          <div class="item-title">补全/自动补全</div>
                        </div>
                      </div></a></li>
                  <li><a href="calendar.html" class="  item-link">
                      <div class="item-content">
                        <div class="item-media"><i class="icon icon-f7"></i></div>
                        <div class="item-inner">
                          <div class="item-title">日历 / 选择日历</div>
                        </div>
                      </div></a></li>
                  ...
                  <li><a href="chips.html" class="  item-link">
                      <div class="item-content">
                        <div class="item-media"><i class="icon icon-f7"></i></div>
                        <div class="item-inner">
                          <div class="item-title">标签/芯片</div>
                        </div>
                      </div></a></li>
                  <li><a href="contacts.html" class="  item-link">
                      <div class="item-content">
                        <div class="item-media"><i class="icon icon-f7"></i></div>
                        <div class="item-inner">
                          <div class="item-title">联系人列表</div>
                        </div>
                      </div></a></li>
                  <li><a href="data-table.html" class="  item-link">
                      <div class="item-content">
                        <div class="item-media"><i class="icon icon-f7"></i></div>
                        <div class="item-inner">
                          <div class="item-title">表格</div><span class="badge bg-green">NEW</span>
                        </div>
                      </div></a></li>
                  <li><a href="floating-button.html" class="  item-link">
                      <div class="item-content">
                        <div class="item-media"><i class="icon icon-f7"></i></div>
                        <div class="item-inner">
                          <div class="item-title">浮动按钮/浮动菜单</div>
                        </div>
                      </div></a></li>
                  ...
                  <li><a href="icons.html" class="  item-link">
                      <div class="item-content">
                        <div class="item-media"><i class="icon icon-f7"></i></div>
                        <div class="item-inner">
                          <div class="item-title">图标</div><span class="badge bg-green">453</span>
                        </div>
                      </div></a></li>
                  <li><a href="infinite-scroll.html" class="  item-link">
                      <div class="item-content">
                        <div class="item-media"><i class="icon icon-f7"></i></div>
                        <div class="item-inner">
                          <div class="item-title">向上滚动刷新</div>
                        </div>
                      </div></a></li>
                  <li><a href="lazy-load.html" class="  item-link">
                      <div class="item-content">
                        <div class="item-media"><i class="icon icon-f7"></i></div>
                        <div class="item-inner">
                          <div class="item-title">图片懒加载</div>
                        </div>
                      </div></a></li>
                  ...
                  <li><a href="picker.html" class="  item-link">
                      <div class="item-content">
                        <div class="item-media"><i class="icon icon-f7"></i></div>
                        <div class="item-inner">
                          <div class="item-title">select选择</div>
                        </div>
                      </div></a></li>
                  <li><a href="popover.html" class="  item-link">
                      <div class="item-content">
                        <div class="item-media"><i class="icon icon-f7"></i></div>
                        <div class="item-inner">
                          <div class="item-title">定位弹出层(tips菜单)</div>
                        </div>
                      </div></a></li>
                  <li><a href="preloader.html" class="  item-link">
                      <div class="item-content">
                        <div class="item-media"><i class="icon icon-f7"></i></div>
                        <div class="item-inner">
                          <div class="item-title">加载等待提示</div>
                        </div>
                      </div></a></li>
                  ...
                  <li><a href="swiper.html" class="  item-link">
                      <div class="item-content">
                        <div class="item-media"><i class="icon icon-f7"></i></div>
                        <div class="item-inner">
                          <div class="item-title">滑块/手滑轮播</div>
                        </div>
                      </div></a></li>
                  ...
                  <li><a href="virtual-list.html" class="  item-link">
                      <div class="item-content">
                        <div class="item-media"><i class="icon icon-f7"></i></div>
                        <div class="item-inner">
                          <div class="item-title">列表数据搜索</div>
                        </div>
                      </div></a></li>
                </ul>
              </div>
              <div class="list-block">
                <ul>
                  ...
                  <li><a href="#" class="  ks-generate-page  item-link">
                      <div class="item-content">
                        <div class="item-media"><i class="icon icon-f7"></i></div>
                        <div class="item-inner">
                          <div class="item-title">动态生成</div>
                        </div>
                      </div></a></li>
                </ul>
              </div>
                ...
                <ul>
                  <li><a href="transitions.html" class="  item-link">
                      <div class="item-content">
                        <div class="item-media"><i class="icon icon-f7"></i></div>
                        <div class="item-inner">
                          <div class="item-title">过度和效果</div>
                        </div>
                      </div></a></li>
    ...
    <script type="text/javascript" src="http://192.168.0.110:81/public/js//framework7.js"></script>
