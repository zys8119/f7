...
<html>
  <head>
    ...
    <link rel="stylesheet" href="../../public/css/material/framework7.material.css">
    <link rel="stylesheet" href="../../public/css/material/framework7.material.colors.css">
        ...
        <div class="pages navbar-fixed">
          <div data-page="index" class="page">
            ...
            <div class="page-content">
                  ...
                  <li><a href="icons.html" class="item-link">
                      <div class="item-content">
                        ...
                        <div class="item-inner">
                          ...
                          <div class="item-after"><span class="badge bg-green">0</span>
                          </div>
                        </div>
                      </div></a></li>
              ...
              <div class="list-block">
                <ul>
                  <li><a href="core-features.html" class="item-link ks-generate-page">
                      <div class="item-content">
                        <div class="item-media"><i class="icon icon-f7"></i></div>
                        <div class="item-inner">
      ...
      <div class="popover-inner">
        <div class="list-block media-list">
          <ul>
            ...
            <li><a href="#" class="item-link item-content bg-purple color-white ripple-white">
