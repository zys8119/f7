...
html
  ...
  body
            ...
            .page-content
              ...
              .list-block
                ul
                  ...
                  li
                    a(href="data-table.html").item-link
                      .item-content
                        .item-media
                          i.icon.icon-f7
                        .item-inner
                          .item-title Data Tables
                          .item-after
                    ...
                    a(href="tabs.html").item-link
                      .item-content
                        ...
                        .item-inner
                          .item-title Tabs
                  li
                    a(href="timeline.html").item-link
                      .item-content
                        .item-media
                          i.icon.icon-f7
                        .item-inner
              ...
              .list-block
                ul
                  li
                    a(href="animation.html").item-link
                      .item-content
                        .item-media
                          i.icon.icon-f7
                        .item-inner
    ...
    script(type="text/javascript", src="../../public/js/framework7.js")
